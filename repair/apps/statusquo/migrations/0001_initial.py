    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', enumfields.fields.EnumIntegerField(default=1, enum=repair.apps.statusquo.models.filters.Role)),
                ('waste_ids', models.TextField(blank=True, null=True, validators=[django.core.validators.RegexValidator(re.compile('^\\d+(?:\\,\\d+)*\\Z'), code='invalid', message='Enter only digits separated by commas.')])),
                ('route', enumfields.fields.EnumIntegerField(default=1, enum=repair.apps.statusquo.models.indicators.TriState)),
                ('collector', enumfields.fields.EnumIntegerField(default=1, enum=repair.apps.statusquo.models.indicators.TriState)),
                ('clean', enumfields.fields.EnumIntegerField(default=1, enum=repair.apps.statusquo.models.indicators.TriState)),
                ('mixed', enumfields.fields.EnumIntegerField(default=1, enum=repair.apps.statusquo.models.indicators.TriState)),
                ('direct', enumfields.fields.EnumIntegerField(default=1, enum=repair.apps.statusquo.models.indicators.TriState)),
                ('year', enumfields.fields.EnumIntegerField(default=1, enum=repair.apps.statusquo.models.filters.Year)),
            ],
            options={
                'abstract': False,
                'default_permissions': ('add', 'change', 'delete', 'view'),
