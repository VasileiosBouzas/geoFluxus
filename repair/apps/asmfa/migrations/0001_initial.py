...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('Reason', 'Reason'), ('Origin', 'Origin'), ('Colour', 'Colour'), ('State', 'State'), ('Dimensions', 'Dimensions'), ('Shape', 'Shape'), ('Consistency', 'Consistency'), ('Codes', 'Codes'), ('Material type', 'Material type'), ('Composition type', 'Composition type'), ('Product type', 'Product type')], default='', max_length=255)),
